...
/*
  ...
  **
  ** SeeedOled.init(SSD1327);  // SSD1327 or SH1107G
  **
*/
...
/*PMS3003*/
#define LENG 31 //23   //0x42 + 31 bytes equal to 32 bytes
...
void draw(){
  ...
  SeeedOled.putString(DATA_UPDATE[0]); SeeedOled.putString(": "); //SeeedOled.putString(GPS_valid);
